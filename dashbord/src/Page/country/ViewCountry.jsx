...
export default function ViewCountry() {
  ...
  const changestatus = () => {
    axios.put(`${import.meta.env.VITE_BASE_URL}/${import.meta.env.VITE_COUNTRY_API}/change-status`, {
      ids: checkBoxValue
    })
      .then((result) => {
        if (result.data._status == true) {
  ...
  const deleteRecords = () => {
    axios.put(`${import.meta.env.VITE_BASE_URL}/${import.meta.env.VITE_COUNTRY_API}/delete`, {
      ids: checkBoxValue
    })
      .then((result) => {
        if (result.data._status == true) {
                      ...
                      <th scope="col" className="p-4">
                        <div className="flex items-center">
                          <input
                            ...
                            checked={checkBoxValue.length == country.length ? 'checked' : ''}
