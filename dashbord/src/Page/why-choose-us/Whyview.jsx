...
export default function Whyview() {
    ...
    useEffect(() => {
        axios.post(`${import.meta.env.VITE_BASE_URL}/${import.meta.env.VITE_WHY_API}/view`, {
            page: currentPage,
            name: searchName
        })
            .then((result) => {
    ...
    const changeStatus = () => {
        axios.post(`${import.meta.env.VITE_BASE_URL}/${import.meta.env.VITE_WHY_API}/change-status`, {
            ids: checkBoxValues
        })
            .then((result) => {
                if (result.data._status == true) {
    ...
    const deleteRecords = () => {
        axios.put(`${import.meta.env.VITE_BASE_URL}/${import.meta.env.VITE_WHY_API}/delete`, {
            ids: checkBoxValues
        })
            .then((result) => {
                if (result.data._status == true) {
    ...
    return (
        <section className="w-full">
            ...
            <Breadcrumb path={"why-choose-us"} link={'/view'} path2={"View"} slash={"/"} />
                                            ...
                                            <th scope="col" class="p-4">
                                                <div class="flex items-center">
                                                    <input id="checkbox-all-search"
                                                        ...
                                                        checked={checkBoxValues.length == whyChoose.length ? 'checked' : ''}
